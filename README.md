...
![Open Issues](https://img.shields.io/github/issues/greenwoodtitus-lab/qa-template)
![Open PRs](https://img.shields.io/github/issues-pr/greenwoodtitus-lab/qa-template)
![Last Commit](https://img.shields.io/github/last-commit/greenwoodtitus-lab/qa-template)
![CI Pipeline Badge](https://github.com/greenwoodtitus-lab/qa-template/actions/workflows/ci.yml/badge.svg)
